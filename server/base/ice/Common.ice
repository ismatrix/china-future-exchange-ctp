...
module CM
{
    ...
    {                                                                                   
		...
		double	  capital		  ;	   /*资金（不含当日持仓盈亏）ctp.balance-ctp.positionprofit / st.deposite*/
    ...
    struct Position
    {
        ...
        int       preholdposition ;    /*昨日余仓			 ctp.POSITION-ctp.TODAYPOSITION/st.PRE_REMAIN_VOL  */
		int		  todayholdposition;   /*今日余仓			 ctp.TODAYPOSITION/st.TOTAL_VOL-st.PRE_REMAIN_VOL*/
        int       position        ;    /*今日总持仓          ctp.Position/st.TOTAL_VOL      */       
        ...
        double    todayopenaverage;    /*今开仓均价          (ctp.OpenAmount/ctp.OpenVolume)*/               
	...
	struct DoOrder
	{
		...
		*/string offsetflag;	/*买卖标志		[ "open", "开仓" ], [ "close", "平仓" ] ["closet", "平今仓"]
