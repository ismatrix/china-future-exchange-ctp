...
::Ice::Int
IceProxy::MdLive::MdSessionCallBack::onBar(const ::std::string& __p_TradingDay, const ::std::string& __p_InstrumentID, const ::CM::Bar& __p_bar, const ::Ice::Context* __ctx)
{
...
::Ice::AsyncResultPtr
IceProxy::MdLive::MdSessionCallBack::begin_onBar(const ::std::string& __p_TradingDay, const ::std::string& __p_InstrumentID, const ::CM::Bar& __p_bar, const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
...
IceProxy::MdLive::MdSessionCallBack::__begin_onBar(const ::std::string& __p_TradingDay, const ::std::string& __p_InstrumentID, const ::CM::Bar& __p_bar, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (::Ice::Int)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent)
{
    ...
    return begin_onBar(__p_TradingDay, __p_InstrumentID, __p_bar, __ctx, new Cpp11CB(__response, __exception, __sent));
}
#endif
...
::Ice::Int
IceProxy::MdLive::MdSession::setCallBack(const ::MdLive::MdSessionCallBackPrx& __p_cb, const ::Ice::Context* __ctx)
{
...
::Ice::AsyncResultPtr
IceProxy::MdLive::MdSession::begin_setCallBack(const ::MdLive::MdSessionCallBackPrx& __p_cb, const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
...
::Ice::AsyncResultPtr
IceProxy::MdLive::MdSession::__begin_setCallBack(const ::MdLive::MdSessionCallBackPrx& __p_cb, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (::Ice::Int)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent)
{
    class Cpp11CB : public ::IceInternal::Cpp11FnCallbackNC
    {
    public:
    ...
    return begin_setCallBack(__p_cb, __ctx, new Cpp11CB(__response, __exception, __sent));
}
#endif
...
{
    __end(__result, __MdLive__MdSession__heartBeat_name);
}
...
MdLive::MdSessionCallBack::___onBar(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
    ...
    __is->read(__p_bar);
    __inS.endReadParams();
    ::Ice::Int __ret = onBar(__p_TradingDay, __p_InstrumentID, __p_bar, __current);
    ::IceInternal::BasicStream* __os = __inS.__startWriteParams(::Ice::DefaultFormat);
    __os->write(__ret);
    __inS.__endWriteParams(true);
    return ::Ice::DispatchOK;
...
{
    ::std::pair< const ::std::string*, const ::std::string*> r = ::std::equal_range(__MdLive__MdSessionCallBack_all, __MdLive__MdSessionCallBack_all + 7, current.operation);
    if(r.first == r.second)
    {
...
namespace
{
const ::std::string __MdLive__MdSession_ids[3] =
{
    "::Glacier2::Session",
    "::Ice::Object",
    "::MdLive::MdSession"
...
{
    return ::std::binary_search(__MdLive__MdSession_ids, __MdLive__MdSession_ids + 3, _s);
}

::std::vector< ::std::string>
MdLive::MdSession::ice_ids(const ::Ice::Current&) const
{
    return ::std::vector< ::std::string>(&__MdLive__MdSession_ids[0], &__MdLive__MdSession_ids[3]);
}

const ::std::string&
MdLive::MdSession::ice_id(const ::Ice::Current&) const
{
    return __MdLive__MdSession_ids[2];
}
...
MdLive::MdSession::___setCallBack(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
    __checkMode(::Ice::Normal, __current.mode);
    ::IceInternal::BasicStream* __is = __inS.startReadParams();
    ::MdLive::MdSessionCallBackPrx __p_cb;
    __is->read(__p_cb);
    __inS.endReadParams();
    ::Ice::Int __ret = setCallBack(__p_cb, __current);
    ::IceInternal::BasicStream* __os = __inS.__startWriteParams(::Ice::DefaultFormat);
    __os->write(__ret);
    __inS.__endWriteParams(true);
    return ::Ice::DispatchOK;
...
{
    ::std::pair< const ::std::string*, const ::std::string*> r = ::std::equal_range(__MdLive__MdSession_all, __MdLive__MdSession_all + 14, current.operation);
    if(r.first == r.second)
    {
        throw ::Ice::OperationNotExistException(__FILE__, __LINE__, current.id, current.facet, current.operation);
    }
