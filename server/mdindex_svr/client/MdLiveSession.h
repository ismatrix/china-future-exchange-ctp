...
public:
    ...
    ::Ice::Int onBar(const ::std::string& __p_TradingDay, const ::std::string& __p_InstrumentID, const ::CM::Bar& __p_bar)
    {
        return onBar(__p_TradingDay, __p_InstrumentID, __p_bar, 0);
    }
    ::Ice::Int onBar(const ::std::string& __p_TradingDay, const ::std::string& __p_InstrumentID, const ::CM::Bar& __p_bar, const ::Ice::Context& __ctx)
    {
        return onBar(__p_TradingDay, __p_InstrumentID, __p_bar, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    ...
    {
        return __begin_onBar(__p_TradingDay, __p_InstrumentID, __p_bar, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_onBar(const ::std::string& __p_TradingDay, const ::std::string& __p_InstrumentID, const ::CM::Bar& __p_bar, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_onBar(__p_TradingDay, __p_InstrumentID, __p_bar, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    ...
    {
        return __begin_onBar(__p_TradingDay, __p_InstrumentID, __p_bar, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    ...
    {
        return begin_onBar(__p_TradingDay, __p_InstrumentID, __p_bar, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
...
public:
    ...
    ::Ice::AsyncResultPtr begin_onBar(const ::std::string& __p_TradingDay, const ::std::string& __p_InstrumentID, const ::CM::Bar& __p_bar)
    {
        return begin_onBar(__p_TradingDay, __p_InstrumentID, __p_bar, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_onBar(const ::std::string& __p_TradingDay, const ::std::string& __p_InstrumentID, const ::CM::Bar& __p_bar, const ::Ice::Context& __ctx)
    {
        return begin_onBar(__p_TradingDay, __p_InstrumentID, __p_bar, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_onBar(const ::std::string& __p_TradingDay, const ::std::string& __p_InstrumentID, const ::CM::Bar& __p_bar, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_onBar(__p_TradingDay, __p_InstrumentID, __p_bar, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_onBar(const ::std::string& __p_TradingDay, const ::std::string& __p_InstrumentID, const ::CM::Bar& __p_bar, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_onBar(__p_TradingDay, __p_InstrumentID, __p_bar, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_onBar(const ::std::string& __p_TradingDay, const ::std::string& __p_InstrumentID, const ::CM::Bar& __p_bar, const ::MdLive::Callback_MdSessionCallBack_onBarPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_onBar(__p_TradingDay, __p_InstrumentID, __p_bar, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_onBar(const ::std::string& __p_TradingDay, const ::std::string& __p_InstrumentID, const ::CM::Bar& __p_bar, const ::Ice::Context& __ctx, const ::MdLive::Callback_MdSessionCallBack_onBarPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_onBar(__p_TradingDay, __p_InstrumentID, __p_bar, &__ctx, __del, __cookie);
    }
...
private:
    ...
    ::Ice::Int onBar(const ::std::string&, const ::std::string&, const ::CM::Bar&, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_onBar(const ::std::string&, const ::std::string&, const ::CM::Bar&, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
class MdSession : virtual public ::IceProxy::Glacier2::Session
{
public:

    ::Ice::Int setCallBack(const ::MdLive::MdSessionCallBackPrx& __p_cb)
    {
        return setCallBack(__p_cb, 0);
    }
    ::Ice::Int setCallBack(const ::MdLive::MdSessionCallBackPrx& __p_cb, const ::Ice::Context& __ctx)
    {
        return setCallBack(__p_cb, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_setCallBack(const ::MdLive::MdSessionCallBackPrx& __p_cb, const ::IceInternal::Function<void (::Ice::Int)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_setCallBack(__p_cb, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_setCallBack(const ::MdLive::MdSessionCallBackPrx& __p_cb, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_setCallBack(__p_cb, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_setCallBack(const ::MdLive::MdSessionCallBackPrx& __p_cb, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (::Ice::Int)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_setCallBack(__p_cb, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_setCallBack(const ::MdLive::MdSessionCallBackPrx& __p_cb, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
...
private:
    ...
    ::Ice::AsyncResultPtr __begin_setCallBack(const ::MdLive::MdSessionCallBackPrx& __p_cb, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (::Ice::Int)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent);
    
public:
#endif

    ::Ice::AsyncResultPtr begin_setCallBack(const ::MdLive::MdSessionCallBackPrx& __p_cb)
    {
        return begin_setCallBack(__p_cb, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_setCallBack(const ::MdLive::MdSessionCallBackPrx& __p_cb, const ::Ice::Context& __ctx)
    {
        return begin_setCallBack(__p_cb, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_setCallBack(const ::MdLive::MdSessionCallBackPrx& __p_cb, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setCallBack(__p_cb, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setCallBack(const ::MdLive::MdSessionCallBackPrx& __p_cb, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setCallBack(__p_cb, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setCallBack(const ::MdLive::MdSessionCallBackPrx& __p_cb, const ::MdLive::Callback_MdSession_setCallBackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setCallBack(__p_cb, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setCallBack(const ::MdLive::MdSessionCallBackPrx& __p_cb, const ::Ice::Context& __ctx, const ::MdLive::Callback_MdSession_setCallBackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setCallBack(__p_cb, &__ctx, __del, __cookie);
    }
...
private:
    ...
    ::Ice::Int setCallBack(const ::MdLive::MdSessionCallBackPrx&, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_setCallBack(const ::MdLive::MdSessionCallBackPrx&, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
public:
...
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_heartBeat(const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_heartBeat(0, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent));
    }
    ::Ice::AsyncResultPtr
    ...
    ::Ice::AsyncResultPtr
    begin_heartBeat(const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_heartBeat(&__ctx, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent), 0);
    }
    ::Ice::AsyncResultPtr
...
public:
    ...
    virtual ::Ice::Int onBar(const ::std::string&, const ::std::string&, const ::CM::Bar&, const ::Ice::Current& = ::Ice::Current()) = 0;
...
class MdSession : virtual public ::Glacier2::Session
{
public:
    ...
    virtual ::Ice::Int setCallBack(const ::MdLive::MdSessionCallBackPrx&, const ::Ice::Current& = ::Ice::Current()) = 0;
...
template<class T>
class CallbackNC_MdSession_heartBeat : public Callback_MdSession_heartBeat_Base, public ::IceInternal::OnewayCallbackNC<T>
{
public:
...
newCallback_MdSession_heartBeat(const IceUtil::Handle<T>& instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_MdSession_heartBeat<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_MdSession_heartBeatPtr
newCallback_MdSession_heartBeat(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_MdSession_heartBeat<T>(instance, 0, excb, sentcb);
}

template<class T> Callback_MdSession_heartBeatPtr
newCallback_MdSession_heartBeat(T* instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_MdSession_heartBeat<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_MdSession_heartBeatPtr
newCallback_MdSession_heartBeat(T* instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_MdSession_heartBeat<T>(instance, 0, excb, sentcb);
}

template<class T, typename CT>
class Callback_MdSession_heartBeat : public Callback_MdSession_heartBeat_Base, public ::IceInternal::OnewayCallback<T, CT>
{
public:
...
newCallback_MdSession_heartBeat(const IceUtil::Handle<T>& instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_MdSession_heartBeat<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_MdSession_heartBeatPtr
newCallback_MdSession_heartBeat(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_MdSession_heartBeat<T, CT>(instance, 0, excb, sentcb);
}

template<class T, typename CT> Callback_MdSession_heartBeatPtr
newCallback_MdSession_heartBeat(T* instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_MdSession_heartBeat<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_MdSession_heartBeatPtr
newCallback_MdSession_heartBeat(T* instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_MdSession_heartBeat<T, CT>(instance, 0, excb, sentcb);
}
