...
void des_crypt( uint32_t SK[32], const uint8_t input[8], uint8_t output[8] )
{
    uint32_t X, Y, T;
...
void des3_crypt( uint32_t SK[96], const uint8_t input[8], uint8_t output[8] )
{
    uint32_t X, Y, T;
